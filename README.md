...
Bu proje, Silkroad Online MMORPG oyununun istemci-sunucu arasındaki ağ trafiğini gerçek zamanlı olarak yakalayıp analiz eden geliştirilmiş bir araçtır. Orijinal açık kaynak projeyi alıp **400+ opcode isim tanımı** ekleyerek paket analizini çok daha anlaşılır hale getirdim.
